...
namespace Ilnurshax\HtmlDomParser\SimpleHtmlDom;

/**
 * Class HtmlDom
 * @package Application\Html\DomParser\SimpleHtmlDom
 * @version 1.5
 */
class HtmlDom
{
    /** @var HtmlDomNode $root */
    public $root = null;
    public $nodes = array();
    ...
    public function getCheckedAttributeByRadioInputs(string $selector)
    {
        return collect($this->find($selector))
            ->first(function (HtmlDomNode $dom_node) {
                return $dom_node->hasAttribute('checked');
            });
    }
